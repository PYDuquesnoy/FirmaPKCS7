...
//
//////////////////////////////////////////////////////////////////////
///PYD+: Need Project to use "Multi-Byte Character Set" to compile conversions from LPCTSTR to const char *
///      Also use CA2T() to convert constants to LPSTR
...
{
	if (szMessage != NULL)
		Base64Coder::Encode((const PBYTE)szMessage, lstrlen(szMessage));
}
...
{
	if (szMessage != NULL)
		Base64Coder::Decode((const PBYTE)szMessage, lstrlen(szMessage));  //PYD: strlen ->lstrlen
}
